...
export const ChatResp: MessageFns<ChatResp> = {
  encode(message: ChatResp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== undefined) {
      Sender.encode(message.sender, writer.uint32(10).fork()).join();
    }
    if (message.message !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ChatResp {
...
export const MovieStatus: MessageFns<MovieStatus> = {
  encode(message: MovieStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MovieStatus {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const MovieStatusChanged: MessageFns<MovieStatusChanged> = {
  encode(message: MovieStatusChanged, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sender !== undefined) {
      Sender.encode(message.sender, writer.uint32(10).fork()).join();
    }
    if (message.status !== undefined) {
      MovieStatus.encode(message.status, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MovieStatusChanged {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const ElementMessage: MessageFns<ElementMessage> = {
  encode(message: ElementMessage, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.type !== 0) {
    ...
    if (message.chatResp !== undefined) {
      ChatResp.encode(message.chatResp, writer.uint32(42).fork()).join();
    }
    if (message.changeMovieStatusReq !== undefined) {
      MovieStatus.encode(message.changeMovieStatusReq, writer.uint32(50).fork()).join();
    }
    if (message.movieStatusChanged !== undefined) {
      MovieStatusChanged.encode(message.movieStatusChanged, writer.uint32(58).fork()).join();
    }
    if (message.changeSeekReq !== 0) {
      writer.uint32(65).double(message.changeSeekReq);
    }
    if (message.checkStatusReq !== undefined) {
      MovieStatus.encode(message.checkStatusReq, writer.uint32(74).fork()).join();
    }
    ...
    if (message.moviesChanged !== undefined) {
      Sender.encode(message.moviesChanged, writer.uint32(98).fork()).join();
    }
    if (message.currentChanged !== undefined) {
      Sender.encode(message.currentChanged, writer.uint32(106).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ElementMessage {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 10: {
          ...
          message.expireId = longToNumber(reader.uint64());
          continue;
        }
        case 11: {
          if (tag !== 88) {
          ...
          message.peopleChanged = longToNumber(reader.int64());
          continue;
        }
        case 12: {
          if (tag !== 98) {
